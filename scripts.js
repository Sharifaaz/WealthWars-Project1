...
// JS File Contains 4 main Functions for the Wealth War Game:
...
let sound = new Audio("mixkit-medieval-show-fanfare-announcement-226.wav")
let sound2 = new Audio("mixkit-males-yes-victory-2012.wav")
...
// Grabbing the imgs on the right section of all cards
...
function flipCards() {
   ...
   console.log(`right card index: ${rightIdx}`)
   console.log(`left card index: ${leftIdx}`)
...
playButton.addEventListener("click",  playFcn)



function playFcn (event) {
   flipCards()
   sound2.play()
...
function gameLogic (lIdx,rIdx) {
   ...
   if (lIdx < rIdx) {
       ...
       finalResult.innerHTML = ("Elon Musk's Net Worth $ 248 B") 
       // for testin' purposes
   ...
   else if (lIdx == '1') 
   {
       ...
       futureNetWorth.innerText = (` $ ${netfutureCounter} B`)
       futureAssets.innerText = (`${futureAssetsCounter} Units`)
       finalResult.innerHTML = ("Jeff Bezos's Net Worth $ 136 B ") 
       // for testin' purposes
       ...
       futureNetWorth.innerText = (` $ ${netfutureCounter} B`)
       futureAssets.innerText = (`${futureAssetsCounter} Units`)
       finalResult.innerHTML = ("Bill Gates's Net Worth $ 103 B") 
       // for testin' purposes
   ...
   { 
       ...
       futureNetWorth.innerText = (` $ ${netfutureCounter} B`)
       futureAssets.innerText = (`${futureAssetsCounter} Units`)
       finalResult.innerHTML = ("Larry Page's Net Worth $ 85 B") 
       // for testin' purposes
       ...
       futureNetWorth.innerText = (` $ ${netfutureCounter} B`)
       futureAssets.innerText = (`${futureAssetsCounter} Units`)
       finalResult.innerHTML = ("Sergey Brin's Net Worth $ 82 B") 
